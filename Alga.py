...
# Définition d'une fonction pour calculer la distance entre deux points géographiques
...
def get_point_info():
    # Demander à l'utilisateur de saisir le nom du point
    name = input("Entrez le nom du point : ")
    # Demander à l'utilisateur de saisir la latitude du point
    lat = float(input("Latitude du point {} : ".format(name)))
    # Demander à l'utilisateur de saisir la longitude du point
